...
import { hashPassword } from './src/ts/utils/auth';
import FuncionarioRepository from './src/ts/repositories/FuncionarioRepository';
import Logger from './src/ts/utils/Logger';
